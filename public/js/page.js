...
if (!frame && !navigator.userAgent.includes("Firefix")) {
  ...
  if (!abcloak || abcloak.closed) {
    alert("Allow popups & redirects for About:Blank Cloaking. By clicking okay, you agree to NovaLabs TOS and Privacy Policy. Will keep reloading until you allow.");
